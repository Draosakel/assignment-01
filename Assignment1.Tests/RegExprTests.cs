...
public class RegExprTests
{
    ...
    [Fact]
    public void Urls_missing_title()
    {
        // Arrange
        var input = "<a href=\"https://en.wikipedia.org/wiki/Theoretical_computer_science\">TESTTEST</a>"; 
        var expected = new List<(Uri, string)>
        {
            (new Uri("https://en.wikipedia.org/wiki/Theoretical_computer_science"), "TESTTEST"),
        };
